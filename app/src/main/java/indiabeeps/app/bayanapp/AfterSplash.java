...
public class AfterSplash extends Activity {
    ...
    private void updateButtonDrawables() {
        ...
        int normalDrawable = isDarkMode ? R.drawable.mybuttondark : R.drawable.mybuttonblue;
        int pressedDrawable = isDarkMode ? R.drawable.mybuttondarkpressed : R.drawable.mybuttonbluepressed;


        btn1.setBackgroundResource(normalDrawable);
        btn2.setBackgroundResource(normalDrawable);
        btn3.setBackgroundResource(normalDrawable);
        btn4.setBackgroundResource(normalDrawable);
        btn5.setBackgroundResource(normalDrawable);
        btnhadis.setBackgroundResource(normalDrawable);
    }
